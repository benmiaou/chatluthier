    ...
    >
      <ScrollArea style={{ height: 'calc(90vh - 120px)' }}>
        <div style={{ padding: '0 1rem' }}>
          ...
          <Text mb="md" style={{ textAlign: 'justify', lineHeight: 1.7 }}>
            The name translates to &quot;The Luthier Cat&quot; in French. A luthier is a craftsman
            who builds or repairs string instruments. Our platform aims to be the artisan of audio
