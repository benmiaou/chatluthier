    ...
    <Container size="md" py="xl">
      <Paper p="xl" radius="md">
        ...
        <Text mb="md" style={{ textAlign: 'justify', lineHeight: 1.7 }}>
          ...
          audio. Our platform offers a rich collection of background music, ambiance sounds, and a
          versatile soundboard to bring your narratives to life.
        </Text>
        ...
        <Text mb="md" style={{ textAlign: 'justify', lineHeight: 1.7 }}>
          ...
          is to provide an easy-to-use platform where game masters, storytellers, and enthusiasts can
          access audio to elevate their sessions.
        </Text>

        <Title order={2} mb="sm">Features</Title>
        ...
        <Title order={2} mb="sm">Credits and Licensing</Title>
        <Text mb="md" style={{ textAlign: 'justify', lineHeight: 1.7 }}>
        ...
        <Title order={2} mb="sm">Why "Le Chat Luthier"?</Title>
        <Text mb="md" style={{ textAlign: 'justify', lineHeight: 1.7 }}>
