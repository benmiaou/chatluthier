            ...
            switch (data.type) {
                case 'subscribe':
                    ...
                    if (!isReconnecting) {
                        ...
                        console.log(`New client joined ID: ${connectedId} with pseudo: ${data.pseudo || 'Anonymous'}`);
                    } else {
                        console.log(`Client reconnected to ID: ${connectedId} with pseudo: ${data.pseudo || 'Anonymous'}`);
                    }
                    break;
